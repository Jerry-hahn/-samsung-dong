    ...
    "prop1": {
        ...
        "items": [
            ...
            },
            {
                ...
                "data": [null, null, null, null, null, 6.20, 8.50, 11.20, 11.80, 10.50, 11.50],
...
function getChartConfig(pair) {
    ...
    document.getElementById('matchedChartSub').innerText = `현재 시세 밴드(${pGroup.rangeStr}) 내 경쟁 단지들의 20년간 시세 형성 과정 및 교차점 분석`;
